...
namespace Utilities
{
    public class WebUtility
    {
        ...
        public async Task<string> PostAsync(string bodyAsJsonString, Dictionary<string, List<string>> headerList)
        {
            using (var httpClient = new HttpClient())
            {
                HttpContent content;
                if (headerList != null)
                {
                    ...
                    {
                        if (httpClient.DefaultRequestHeaders.Contains(_header.Key))
                        {
                            httpClient.DefaultRequestHeaders.Remove(_header.Key);
                        }
                        httpClient.DefaultRequestHeaders.TryAddWithoutValidation(_header.Key, _header.Value);
                    }
