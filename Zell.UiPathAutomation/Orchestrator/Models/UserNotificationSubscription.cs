...
namespace Zell.UiPathAutomation.Orchestrator.Models
{
    ...
    public partial class UserNotificationSubscription
    {
        ...
        /// class.
        /// </summary>
        public UserNotificationSubscription(bool? queues = default(bool?), bool? robots = default(bool?), bool? jobs = default(bool?), bool? schedules = default(bool?), bool? tasks = default(bool?), bool? queueItems = default(bool?), bool? insights = default(bool?))
        {
            Queues = queues;
            Robots = robots;
            Jobs = jobs;
